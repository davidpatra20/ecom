    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
          <div class="x_panel">
            <div class="x_title">
              <h2>New Imane</h2>
              <a href="{{route('admin.image')}}" class="float-right"><i class="fa fa-mail-reply-all "></i> Back</a>
                                        ...
                                        <div class="row">
                                          <div class="col-md-7">
                                            ...
                                            <div class="item form-group">
                                              ...
                                              <div class="col-md-8 col-sm-3 ">
                                                <textarea id="middle-name" class="form-control" style="height: 120px"></textarea>
                                              </div>
                                            </div>
