...
<div class="right_col" role="main">
      ...
      <div class="col-md-12 col-sm-12 ">
          <div class="x_panel">
            <div class="x_title">
              <h2>New Slider</h2>
              <a href="{{route('admin.slider')}}" class="float-right"><i class="fa fa-mail-reply-all "></i> Back</a>
                ...
                <div class="row">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-4 col-sm-3 label-align" for="last-name">Status <span class="required">*</span>
                        </label>
                        <div class="col-md-8 col-sm-3 ">
