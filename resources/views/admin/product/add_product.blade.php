              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-7">
                              <div class="item form-group">
                                <label class="col-form-label col-md-4 col-sm-4 label-align" for="first-name">Product Name <span class="required">*</span>
                              </label>
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-3 ">
                              <textarea id="middle-name" class="form-control" row="7" style="height: 120px"></textarea>
                            </div>
                          </div>
                    ...
                    <div class="col-md-5">
                      <label>
                        <img src="{{asset('public/admin_asset/images/imagesframe.png')}}" height="225" style="border:2px dashed #a8c3e4; border-radius: 5px;" id="output_img">
