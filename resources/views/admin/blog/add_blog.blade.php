...
<div class="right_col" role="main">
      ...
      <div class="col-md-12 col-sm-12 ">
          <div class="x_panel">
            <div class="x_title">
              <h2>New Blog</h2>
              <a href="{{route('admin.blog')}}" class="float-right"><i class="fa fa-mail-reply-all "></i> Back</a>
            ...
            <div class="x_content">
                <div class="row">
                    ...
                    <div class="card">
                      ...
                      <div class="col-md-5">
                        <label>
                          <img src="{{asset('public/admin_asset/images/imagesframe.png')}}" width="240"  style="border:2px dashed #a8c3e4; border-radius: 5px;" id="output_img">
