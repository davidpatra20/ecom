  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 ">
      <div class="x_panel">
        <div class="x_title">
          <h2>New Video</h2>
          <a href="{{route('admin.video')}}" class="float-right"><i class="fa fa-mail-reply-all "></i> Back</a>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        <label>
                          <img src="{{asset('public/admin_asset/images/imagesframe.png')}}" width="265" height="225" id="output_img">
